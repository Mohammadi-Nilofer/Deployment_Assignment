...
brand = st.sidebar.selectbox('Brand', df1['Brand'].unique())
model_name = st.sidebar.selectbox('Model', df1[df1['Brand'] == brand]['Model'].unique())
...
fuel_type = st.sidebar.selectbox('Fuel Type', df1['Fuel_Type'].unique())
transmission = st.sidebar.selectbox('Transmission', df1['Transmission'].unique())
